...
_The code below works in an interactive R session, but not with markdown. Markdown makes a clean environment when knitting. I haven't been able to figure out why this messes with the grid.arrange()_ 
```
